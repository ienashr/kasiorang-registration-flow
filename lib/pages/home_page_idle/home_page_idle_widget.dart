...
import 'home_page_idle_model.dart';
export 'home_page_idle_model.dart';

class HomePageIdleWidget extends StatefulWidget {
  const HomePageIdleWidget({
    Key? key,
  ...
  @override
  _HomePageIdleWidgetState createState() => _HomePageIdleWidgetState();
}

class _HomePageIdleWidgetState extends State<HomePageIdleWidget> {
  late HomePageIdleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageIdleModel());
